...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Accueil du Forum</a> &gt; Nouvelle catégorie
    </div>
	<div class="box_right">
...
<form action="new_category.php" method="post">
	<p><label for="name">Nom</label><input type="text" name="name" id="name" /></p><br />
	<label for="description">Description</label>(html accepté)<br />
    <p><textarea name="description" id="description" cols="70" rows="6"></textarea></p><br />
