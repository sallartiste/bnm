...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Accueil du Forum</a> &gt; <?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?> &gt; Modifier la catégorie
    </div>
	<div class="box_right">
...
if(isset($_POST['name'], $_POST['description']) and $_POST['name']!='')
{
	...
	<a href="<?php echo $url_home; ?>">Retourner à l'accueil du Forum</a></div>
	<?php
	}
	else
	{
...
<form action="edit_category.php?id=<?php echo $id; ?>" method="post">
	<p><label for="name">Nom</label><input type="text" name="name" id="name" value="<?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?>" /></p><br />
	<label for="description">Description</label>(html accepté)<br />
    <p><textarea name="description" id="description" cols="70" rows="6"><?php echo htmlentities($dn1['description'], ENT_QUOTES, 'UTF-8'); ?></textarea></p><br />
