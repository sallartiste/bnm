...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Accueil du Forum</a> &gt; <a href="list_pm.php">Liste de vos MPs</a> &gt; Nouveau MP
    </div>
	<div class="box_right">
    ...
    <form action="new_pm.php" method="post">
		<p><em>Veuillez remplir ce formulaire pour envoyer le MP.</em></p><br />
        <p><label for="title">Titre</label><input type="text" value="<?php echo htmlentities($otitle, ENT_QUOTES, 'UTF-8'); ?>" id="title" name="title" /></p><br />
        <p><label for="recip">Destinataire<span class="small"> (Nom d'utilisateur)</span></label><input type="text" value="<?php echo htmlentities($orecip, ENT_QUOTES, 'UTF-8'); ?>" id="recip" name="recip" /></p><br />
        <p><label for="message">Message</label><textarea cols="40" rows="5" id="message" name="message"><?php echo htmlentities($omessage, ENT_QUOTES, 'UTF-8'); ?></textarea></p><br />
