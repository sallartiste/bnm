...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Accueil du Forum</a> &gt; <a href="list_topics.php?parent=<?php echo $dn1['parent']; ?>"><?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; <a href="read_topic.php?id=<?php echo $id; ?>"><?php echo htmlentities($dn1['title'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; Ajout d'une réponse
    </div>
	<div class="box_right">
...
<form action="new_reply.php?id=<?php echo $id; ?>" method="post">
    ...
    <p><textarea name="message" id="message" cols="70" rows="6"></textarea></p><br />
