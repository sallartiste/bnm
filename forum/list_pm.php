...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Accueil du Forum</a> &gt; Liste de vos Messages Personnels
    </div>
	<div class="box_right">
...
<p><em>Voici la liste de vos messages :</em></p><br />
<p><a href="new_pm.php" class="button">Nouveau message priv&eacute;</a></p><br />
