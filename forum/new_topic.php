...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Accueil du Forum</a> &gt; <a href="list_topics.php?parent=<?php echo $id; ?>"><?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; Nouveau Sujet
    </div>
	<div class="box_right">
...
<form action="new_topic.php?parent=<?php echo $id; ?>" method="post">
	<p><label for="title">Titre</label><input type="text" name="title" id="title"  /></p><br />
